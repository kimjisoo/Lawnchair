...
public class LauncherFiles {
    ...
    public static final String OLD_SHARED_PREFERENCES_KEY = "ch.deletescape.lawnsearch.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "ch.deletescape.lawnsearch.managedusers.prefs";
